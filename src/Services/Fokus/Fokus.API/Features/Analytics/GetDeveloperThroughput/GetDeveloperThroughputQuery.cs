...
public class GetDeveloperThroughputRequest
{
...
public class GetDeveloperThroughputRequestValidator : Validator<GetDeveloperThroughputRequest>
{
    public GetDeveloperThroughputRequestValidator()
    {
